...
class ChefTest < ActiveSupport::TestCase
  ...
  test "email should not be too long" do
    ...
    test "email validation should be accept valid addresses" do
      valid_addresses = %w[user@eee.com RTDD-DS@eee.hello.org user@example.com first.last@eem.au  laura+joe@monk.cm]
    ...
    test "email validation should be reject valid addresses" do
      invalid_addresses = %w[user@example,com user_at_eee_org user.name@example. eee@i_am.com foo@eee+ar.com]
